// ═══════════════════════════════════════════════════════════════
// SHARED — loaded by every page before its tool script.
// Chrome only: the starfield backdrop and nav behaviour. Tool logic
// lives in npc.js / veilstrider.js / leviathan.js.
// ═══════════════════════════════════════════════════════════════
...
// -- Nav dropdown --------------------------------------------------------
// Kept here rather than duplicated in each tool script.
